...
public sealed class PlanningPokerHubTest : IDisposable
{
    ...
    [TestMethod]
    public void SubmitEstimation_TeamNameAndScrumMasterNameAndInfinityEstimation_EstimationOfMemberIsSetToInfinity()
    {
        // Arrange
        var team = CreateBasicTeam();
    ...
    [TestMethod]
    public void SubmitEstimation_TeamNameAndMemberNameAndInfinityEstimation_EstimationOfMemberIsSetInifinty()
    {
        // Arrange
        var team = CreateBasicTeam();
        var member = (D.Member)team.Join(MemberName, false);
